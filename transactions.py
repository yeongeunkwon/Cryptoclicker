...
["GTX 1060",     0,         0,         0,       0.001853, 1.24,   120,  200],
["GTX 1070", 0, 0, 0, 0.001853*.25, 1.24*2.5, 120, 300],
["GTX 1080", 0, 0, 0, 0.001853*.4, 1.25*.5, 140, 500]]
...
def getcointotals():
    ...
    for element in transactionlist:
        if element[2] not in coins[0]:
            ...
            #coins[1][i] += element[1]*element[3]*element[4]
